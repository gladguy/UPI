...
switch($_GET["action"]) {
	...
	case "mobile":
		...
		include "PayZee/qrlib.php";  

		$QRCodeString = "PVA=amazon@mapp&payeeName=Amazon Corp&appname=Amazon&am=".$total_amount."&OrderID=".$payment_id;
		$QRCodename = mt_rand();
		$mobile_image = $total_amount.'_'.$QRCodename.'.png';

		//QRcode::png($payment_id."|".$total_amount, $total_amount.'.png'); // creates file 			
		QRcode::png($QRCodeString, $mobile_image); // creates file 			
